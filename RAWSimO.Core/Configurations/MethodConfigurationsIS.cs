...
namespace RAWSimO.Core.Configurations
{
    ...
    /// The configuration for the corresponding method.
    /// </summary>
    public class LocationItemStorageConfiguration : ItemStorageConfiguration
    {
        /// <summary>
        /// Returns the type of the corresponding method this configuration belongs to.
        /// </summary>
        /// <returns>The type of the method.</returns>
        public override ItemStorageMethodType GetMethodType() { return ItemStorageMethodType.Location; }
        /// <summary>
        /// Returns a name identifying the method.
        /// </summary>
        /// <returns>The name of the method.</returns>
        public override string GetMethodName() { if (!string.IsNullOrWhiteSpace(Name)) return Name; return "isL" + (StickToPodUntilFull ? "t" : "f") + BufferThreshold.ToString(IOConstants.EXPORT_FORMAT_SHORTER, IOConstants.FORMATTER); }
        /// <summary>
        /// Indicates whether the randomly chosen pod will be used again for other bundles until it is full or setdown.
        /// </summary>
        public bool StickToPodUntilFull = true;
