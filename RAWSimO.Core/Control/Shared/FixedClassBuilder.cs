...
namespace RAWSimO.Core.Control.Shared
{
    ...
    /// </summary>
    public enum FixedPodStorageLocationClassRule
    {
        /// <summary>
    ...
    /// </summary>
    public enum FixedPodStorageLocationDisposeRule
    {
        /// <summary>
    ...
    /// </summary>
    internal class FixedClassBuilder : IUpdateable
    {
        /// <summary>
        /// Initializes this class manager.
        /// </summary>
        /// <param name="instance">The active instance.</param>
        public FixedClassBuilder(Instance instance) { Instance = instance; instance.NewOrder += NewOrderCallback; }
        ...
        /// </summary>
        private FixedPodStorageLocationClassRule _storageLocationClassRule = FixedPodStorageLocationClassRule.OutputStationDistanceShortestTime;
        /// <summary>
        ...
        private void Init()
        {
            ...
            if (Instance.Controller.PodStorageManager is FixedPodStorageManager)
                _storageLocationClassRule = (Instance.ControllerConfig.PodStorageConfig as FixedPodStorageConfiguration).StorageLocationClassRule;
            ...
            _storageLocationsOrdered = Instance.Waypoints
                ...
                .OrderBy(wp => Instance.OutputStations.Min(o =>
                {
                    ...
                    {
                        case FixedPodStorageLocationClassRule.OutputStationDistanceEuclidean: value = Distances.CalculateEuclid(wp, o, Instance.WrongTierPenaltyDistance); break;
                        case FixedPodStorageLocationClassRule.OutputStationDistanceManhattan: value = Distances.CalculateManhattan(wp, o, Instance.WrongTierPenaltyDistance); break;
                        case FixedPodStorageLocationClassRule.OutputStationDistanceShortestPath: value = Distances.CalculateShortestPathPodSafe(wp, o.Waypoint, Instance); break;
                        case FixedPodStorageLocationClassRule.OutputStationDistanceShortestTime: value = Distances.CalculateShortestTimePathPodSafe(wp, o.Waypoint, Instance); break;
                ...
                .ThenBy(p => Instance.OutputStations.Min(o =>
                 {
                     ...
                     switch (_storageLocationClassRule)
                     {
                         case FixedPodStorageLocationClassRule.OutputStationDistanceEuclidean:
                             value = Distances.CalculateEuclid(p, o, Instance.WrongTierPenaltyDistance); break;
                         case FixedPodStorageLocationClassRule.OutputStationDistanceManhattan:
                             value = Distances.CalculateManhattan(p, o, Instance.WrongTierPenaltyDistance); break;
                         case FixedPodStorageLocationClassRule.OutputStationDistanceShortestPath:
                         ...
                         case FixedPodStorageLocationClassRule.OutputStationDistanceShortestTime:
