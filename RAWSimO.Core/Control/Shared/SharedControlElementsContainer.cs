...
namespace RAWSimO.Core.Control.Shared
{
    ...
    internal class SharedControlElementsContainer : IUpdateable
    {
        ...
        /// </summary>
        public FixedClassBuilder _FixedClassBuilder;
        /// <summary>
        /// Class builder for Fixed based mechanisms.
        /// </summary>
        public FixedClassBuilder FixedClassBuilder { get { if (_FixedClassBuilder == null) _FixedClassBuilder = new FixedClassBuilder(_instance); return _FixedClassBuilder; } }
        /// <summary>
